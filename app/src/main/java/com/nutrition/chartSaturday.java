...
public class chartSaturday {
    ...
    //it sets the burned calories in saturday
    public void setBurnedCalories(double burnedCalories) {
        this.burnedCalories = burnedCalories;
    }

    //it sets the intaked calories in saturday
    public void setIntakedCalories(double intakedCalories) {
        this.intakedCalories = intakedCalories;
    }

    //it returns the burned calories in saturday
    public double getBurnedCalories() {
        return burnedCalories;
    }

    //it returns the intaked calories in saturday
